export const supabaseAuthFixtures = {
  ...
  signInSuccess: {
    ...
    session: {
      access_token:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..test-jwt-signature',
      token_type: 'bearer',
      expires_in: 3600,
