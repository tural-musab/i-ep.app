      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Tenantlara ait özel domainleri yönetin
          </p>
        </div>
        <Button 
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Bir tenant için yeni bir domain ekleyin. Domain ekledikten sonra DNS ayarlarını yaparak doğrulamanız gerekecektir.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">Alt domain olmadan tam domain adını girin (örn: ornek.com)</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                {domains.map(domain => domain.tenant_id && domain.tenant_name ? (
        ...
        <Dialog open={isVerifyDialogOpen} onOpenChange={setIsVerifyDialogOpen}>
          <DialogContent className="sm:max-w-[600px]">
            <DialogHeader>
              ...
              <DialogDescription>
                <span className="font-medium">{selectedDomain.domain}</span> domainini doğrulamak için aşağıdaki DNS kayıtlarını ekleyin.
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4 py-4">
              ...
              <div className="rounded-md bg-muted p-4">
                ...
                <div className="grid grid-cols-3 gap-2 text-xs">
                  ...
                  <div className="break-all">{selectedDomain.verification_code || 'i-ep-verification=abcdef123456'}</div>
                  <div>3600</div>
                </div>
              </div>
              
              <p className="text-sm text-muted-foreground">
                DNS kayıtları ekledikten sonra, değişikliklerin yayılması biraz zaman alabilir. Kayıtlar eklendikten sonra doğrulama işlemi yapabilirsiniz.
              </p>
            </div>
            <DialogFooter>
              <Button variant="outline" onClick={() => setIsVerifyDialogOpen(false)}>İptal</Button>
        ...
        <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                <span className="font-medium">{selectedDomain.domain}</span> domainini silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
              <p className="text-sm text-destructive">
                Bu domain silindiğinde, bu domaini kullanan kullanıcılar sistem ana domain üzerinden erişim sağlamak zorunda kalacaklar.
              </p>
            </div>
            <DialogFooter>
              <Button variant="outline" onClick={() => setIsDeleteDialogOpen(false)}>İptal</Button>
              <Button variant="destructive" onClick={handleDeleteDomain}>Sil</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      )}
