            ...
            <TabsContent value="security">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Hesabınızın şifresini güncelleyin. Güvenliğiniz için güçlü bir şifre
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription>Şifreniz en az 8 karakter olmalıdır.</FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                      />
                ...
                <CardFooter className="flex flex-col items-start">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Bu işlem geri alınamaz. Hesabınızı sildiğinizde, tüm verileriniz kalıcı olarak
                      silinecektir.
                    </p>
                  </div>
                  <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Bu işlem geri alınamaz. Hesabınızı sildiğinizde, tüm verileriniz kalıcı
                          olarak silinecektir.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
