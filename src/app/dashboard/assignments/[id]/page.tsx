  ...
  const stats = {
    ...
    averageScore:
      assignment.submissions
        ...
        assignment.submissions.filter((s) => s.score !== null).length || 0,
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground mt-1 text-xs">Notlandırılacak teslim</p>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="mb-2 font-medium">Açıklama</h3>
                <p className="text-gray-600">{assignment.description}</p>
              </div>

              <div>
                <h3 className="mb-2 font-medium">Talimatlar</h3>
                <p className="whitespace-pre-wrap text-gray-600">{assignment.instructions}</p>
              </div>

              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  <h3 className="mb-2 font-medium">Ödev Bilgileri</h3>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>
                        {assignment.allowLateSubmission ? 'İzin Veriliyor' : 'İzin Verilmiyor'}
                      </span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div>
                  <h3 className="mb-2 font-medium">Öğretmen Bilgileri</h3>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span>Öğretmen:</span>
        ...
        <TabsContent value="submissions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {stats.totalSubmissions} teslim, {stats.gradedSubmissions} notlandırıldı,{' '}
                {stats.pendingSubmissions} bekliyor
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="rubric" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Ödevin değerlendirilme kriterleri</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <TabsContent value="analytics" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Ödev performansı ve istatistikleri</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                  <h3 className="mb-4 font-medium">Puan Dağılımı</h3>
                  <div className="space-y-2">
                    ...
                    <div className="h-2 w-full rounded-full bg-gray-200">
                      <div className="h-2 rounded-full bg-green-600" style={{ width: '20%' }}></div>
                    </div>
                ...
                <div>
                  <h3 className="mb-4 font-medium">Teslim Zamanları</h3>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span>Zamanında</span>
