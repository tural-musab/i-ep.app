      ...
      <main className="flex-grow py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-1/4">
                <select
                  className="block w-full pl-3 pr-10 py-2 text-base border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {category.documents.map(doc => (
                      <Link key={doc.id} href={doc.link}>
                        <div className="bg-white shadow rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer h-full flex flex-col">
                          ...
                          <p className="text-gray-600 flex-grow">{doc.description}</p>
            ...
            <>
              <div className="mb-6">
                <h2 className="text-xl font-medium text-gray-900">
                  {searchQuery ? `"${searchQuery}" için arama sonuçları` : `${docCategories.find(c => c.id === selectedCategory)?.name || 'Tüm Dokümanlar'}`}
                </h2>
              ...
              {filteredDocuments.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="mt-1 text-gray-500">Arama terimlerinizi değiştirerek veya farklı bir kategori seçerek tekrar deneyin.</p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="mt-16 pt-6 border-t border-gray-200">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Popüler Dokümanlar</h2>
