...
import { rateLimit, RateLimitResult } from './security/rate-limiter';
...
export const demoAnalyticsRateLimit = (request: NextRequest) =>
  rateLimit(request, {
...
export const demoBatchRateLimit = (request: NextRequest) =>
  rateLimit(request, {
    windowMs: 60 * 1000, // 1 minute
...
export const demoLocationRateLimit = (request: NextRequest) =>
  rateLimit(request, {
    windowMs: 60 * 1000, // 1 minute
...
export const demoDashboardRateLimit = (request: NextRequest) =>
  rateLimit(request, {
    windowMs: 60 * 1000, // 1 minute
