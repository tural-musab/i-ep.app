...
class MiddlewarePerformanceMonitor {
  ...
  finishRequest(context: any, outcome: 'success' | 'redirect' | 'error', cacheHit: boolean = false) {
    ...
    const metric: PerformanceMetrics = {
      ...
      tenantResolutionTime: context.tenantStart ? (context.authStart || endTime) - context.tenantStart : 0,
