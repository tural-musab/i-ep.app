 ...
 * @returns Erişim hakkı varsa true, yoksa false
 */
export async function checkTeacherStudentAccess(teacherId: string, studentId: string): Promise<boolean> {
  try {
 ...
 * @returns Erişim hakkı varsa true, yoksa false
 */
export async function checkTeacherClassAccess(teacherId: string, classId: string): Promise<boolean> {
  try {
