...
export interface VulnerabilityTest {
  ...
  category: "injection" | "authentication" | "authorization" | "encryption" | "configuration" | "input_validation"
...
export class PenetrationTestingSuite {
  ...
  async runAllTests(): Promise<{ passed: number; failed: number; results: Array<{ test: string; result: TestResult }> }> {
