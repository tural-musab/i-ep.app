...
export function SkipLink({ href, children, className }: SkipLinkProps) {
  return (
    <a
      href={href}
      className={cn(
        'bg-primary text-primary-foreground absolute top-0 left-0 z-[9999] px-4 py-2 font-medium',
        '-translate-y-full transform transition-transform duration-150 focus:translate-y-0',
  ...
  return (
    <div className="space-y-2">
      ...
      <select
        ...
        className={cn(
          'border-input bg-background flex h-10 w-full rounded-md border px-3 py-2 text-sm',
          'ring-offset-background focus-visible:ring-2 focus-visible:outline-none',
          'focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
          error && 'border-red-500 focus-visible:ring-red-500',
          className
        )}
