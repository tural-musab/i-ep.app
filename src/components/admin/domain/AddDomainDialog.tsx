                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Tenant ID girin" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="flex items-center">
                          <Input placeholder="okul-adi" {...field} />
                          <span className="text-muted-foreground ml-2">.i-ep.app</span>
                        </div>
                      </FormControl>
                      <FormDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="örn: okul-adi.com" {...field} />
                      </FormControl>
                      <FormDescription>Tam domain adresini girin.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                      ...
                      <FormControl>
                        ...
                        >
                          <FormItem className="flex items-center space-y-0 space-x-3">
                            ...
                            <FormLabel className="font-normal">Secondary Domain</FormLabel>
                          </FormItem>
                          <FormItem className="flex items-center space-y-0 space-x-3">
                            <FormControl>
