      ...
      <div
        className={cn(
          'mt-0.5 flex h-6 w-6 items-center justify-center rounded-full border text-xs',
          {
            ...
            'bg-primary border-primary text-white': status === 'current',
            'border-green-500 bg-green-500 text-white': status === 'complete',
          }
        )}
      >
    ...
    <Card className="w-full">
      ...
      <CardContent>
        ...
        <div className="mb-6">
          <Steps size="sm" activeStep={getActiveStep()}>
            <Step
              ...
              status={
                getActiveStep() >= 0 ? (getActiveStep() > 0 ? 'complete' : 'current') : 'waiting'
              }
            />
            <Step
              ...
              status={
                getActiveStep() >= 1 ? (getActiveStep() > 1 ? 'complete' : 'current') : 'waiting'
              }
            />
            <Step
        ...
        <div className="bg-muted mb-4 rounded-md p-4">
          <h3 className="mb-2 text-sm font-semibold">DNS Kaydı Ekleme Talimatları</h3>
          ...
          <div className="bg-background mb-4 grid grid-cols-4 gap-2 rounded p-2 text-sm">
          ...
          <p className="text-muted-foreground text-xs">
            Not: DNS değişikliklerinin yayılması 24-48 saat sürebilir, ancak genellikle daha kısa
            sürede tamamlanır.
          </p>
        </div>
      ...
      <CardFooter className="flex justify-between">
        ...
        <Button variant="default" onClick={checkVerificationStatus} disabled={checking}>
