  ...
  return (
    <Card className={cn('mx-auto w-full max-w-2xl', className)}>
      <CardHeader>
        ...
        <CardDescription>
          {planName} planı için {billingCycle === 'yearly' ? 'yıllık' : 'aylık'} ödeme ({amount}{' '}
          {currency})
        </CardDescription>
      </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="acceptTerms" className="text-sm">
                <span className="text-red-500">*</span> Hizmet şartlarını ve gizlilik politikasını
                kabul ediyorum
              </Label>
            </div>
          ...
          <div className="flex items-center gap-2 rounded-lg bg-green-50 p-4">
            ...
            <div className="text-sm text-green-700">
              <strong>Güvenli Ödeme:</strong> Tüm ödeme bilgileriniz SSL ile şifrelenir ve güvenli
              bir şekilde işlenir.
            </div>
          </div>
        </CardContent>
