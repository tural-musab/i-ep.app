...
export function ParentNotificationSystem() {
  const [selectedTab, setSelectedTab] = useState<'pending' | 'templates' | 'history' | 'settings'>('pending');
  ...
  const [notificationTemplates] = useState<NotificationTemplate[]>([
    {
      ...
      content: 'Sayın {parent_name}, {student_name} adlı öğrenciniz {date} tarihinde devamsızlık yapmıştır.',
    ...
    },
    {
      ...
      content: 'Sayın {parent_name}, {student_name} adlı öğrenciniz bugün {time} saatinde okula gelmiştir.',
    ...
    },
    {
      ...
      content: 'Sayın {parent_name}, {student_name} adlı öğrencinizin devamsızlık oranı %{rate} olmuştur. Lütfen okulla iletişime geçiniz.',
  ...
  const [notificationHistory] = useState<NotificationHistory[]>([
    {
      ...
      content: 'Sayın Ahmet Veli, Ali Veli adlı öğrenciniz 14.01.2025 tarihinde devamsızlık yapmıştır.'
    },
    {
      id: '2',
      student: {
      ...
      content: 'Sayın Mehmet Yılmaz, Ayşe Yılmaz adlı öğrencinizin devamsızlık oranı %25 olmuştur. Lütfen okulla iletişime geçiniz.'
    }
  ]);
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      case 'tardiness': return <Clock className="h-4 w-4" />;
      case 'chronic': return <AlertCircle className="h-4 w-4" />;
              ...
              {pendingNotifications.map((notification) => (
                <div
                  ...
                  className={`p-4 border rounded-lg ${
                    selectedNotifications.includes(notification.id) ? 'border-blue-500 bg-blue-50' : ''
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleNotificationSelection(notification.id, checked as boolean)}
                      />
      ...
      {selectedTab === 'history' && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Gönderilmiş bildirimlerin detayları ve durumları
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
                ...
                <div key={notification.id} className="p-4 border rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-6 text-sm text-gray-600">
                      <div>
                        <span className="font-medium">Gönderilme:</span> {new Date(notification.sentAt).toLocaleString('tr-TR')}
                      </div>
                      {notification.deliveredAt && (
                        <div>
                          <span className="font-medium">Teslim edilme:</span> {new Date(notification.deliveredAt).toLocaleString('tr-TR')}
                        </div>
                      )}
                      {notification.readAt && (
                        <div>
                          <span className="font-medium">Okunma:</span> {new Date(notification.readAt).toLocaleString('tr-TR')}
                        </div>
                      )}
                    </div>
                  </div>
      ...
      {selectedTab === 'settings' && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Otomatik bildirim sisteminin genel ayarları
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Her devamsızlık için otomatik bildirim gönder</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Geç kalma durumunda otomatik bildirim gönder</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Yüksek devamsızlık oranında uyarı gönder</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                </div>
