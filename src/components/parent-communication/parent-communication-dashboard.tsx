    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-green-600">
              ...
              +{communicationStats.trendValue}% bu ay
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-600">{communicationStats.satisfactionRating}/5</div>
            <p className="text-xs text-muted-foreground">
              Ortalama puan
            </p>
          </CardContent>
              ...
              {upcomingMeetings.map((meeting) => (
                <div key={meeting.id} className="p-3 border rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div>
                        <p className="font-medium text-sm">{meeting.parent}</p>
                    ...
                    <div className="flex items-center gap-4 text-xs text-gray-600">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        {meeting.mode === 'online' ? 'Online' : 
                         meeting.mode === 'in_person' ? 'Yüz yüze' : 'Telefon'}
                      </div>
                    </div>
                    <div className="flex items-center gap-2 text-xs text-gray-600">
                      <BookOpen className="h-3 w-3" />
                      <span>{meeting.teacher} - {meeting.subject}</span>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              En çok etkileşim kuran veliler
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Kanal kullanımı ve performans metrikleri
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Sık kullanılan iletişim işlemleri
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
