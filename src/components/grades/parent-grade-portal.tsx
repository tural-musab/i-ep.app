...
export function ParentGradePortal() {
  ...
  const [studentData] = useState<{
    ...
    overview: {
      ...
      trendValue: 0.2,
      achievements: [
        'Matematik yarışması 2. liği',
        'Mükemmel devam ödülü',
    ...
    grades: [
      {
        ...
        teacherComments: [
          {
            date: '2025-01-15',
            comment: 'Ali matematik dersinde çok başarılı. Problem çözme becerileri gelişiyor.',
            category: 'positive',
          },
      ...
      },
      {
        ...
        teacherComments: [
          {
            date: '2025-01-14',
            comment: 'Yazma becerilerinde büyük gelişim var. Okuma alışkanlığı da artmış.',
            category: 'positive',
          },
          {
            date: '2025-01-07',
            comment: 'Sözlü sunum becerilerinı geliştirmeli.',
            category: 'neutral',
          },
        ],
      },
        ...
        teacherComments: [
          {
            date: '2025-01-13',
            comment:
              'Fen bilgisi dersinde daha fazla çalışma gerekli. Temel kavramlar pekiştirilmeli.',
            category: 'concern',
          },
          {
            date: '2025-01-06',
            comment: 'Deney çalışmalarında aktif ve başarılı.',
            category: 'positive',
          },
        ],
      },
      {
        ...
        teacherComments: [
          {
            date: '2025-01-15',
            comment: 'Araştırma projesi çok başarılı. Tarih konularında özel ilgi gösteriyor.',
            category: 'positive',
          },
        ],
      },
  ...
  const filteredGrades =
    selectedSubject === 'all'
      ...
      : data.grades.filter((grade) =>
          grade.subject.toLowerCase().includes(selectedSubject.toLowerCase())
        );
    ...
    <div className="container mx-auto space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-gray-600">Çocuğunuzun akademik durumunu takip edin</p>
        </div>
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Badge
                    variant="outline"
                    className={getGradeBadge(data.overview.semesterGPA * 25)}
                  >
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <div className="rounded-lg bg-purple-50 p-4 text-center">
              <div className="text-2xl font-bold text-purple-600">{data.overview.rank}</div>
          ...
          <CardContent>
            <div className="space-y-3">
              {data.overview.concerns.map((concern, index) => (
                <div key={index} className="flex items-center gap-2 rounded-lg bg-red-50 p-3">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <span
                            className={`text-2xl font-bold ${getGradeColor(grade.currentGrade)}`}
                          >
                            {grade.currentGrade}
                          </span>
                        </div>
                        ...
                        <div className="space-y-2">
                          <h4 className="text-sm font-medium">Son Notlar</h4>
                          <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
                            {grade.recentGrades.map((recentGrade, idx) => (
                              <div key={idx} className="rounded-lg border p-3">
                                <div className="flex items-start justify-between">
                                  <div>
                                    <div className="text-sm font-medium">{recentGrade.type}</div>
                                  ...
                                  <div className="text-right">
                                    <div
                                      className={`font-bold ${getGradeColor(recentGrade.grade)}`}
                                    >
                                      {recentGrade.grade}
                                    </div>
                                    <div className="text-xs text-gray-600">
                        ...
                        <div className="space-y-2">
                          <h4 className="text-sm font-medium">Öğretmen Yorumları</h4>
                          <div className="space-y-2">
                            {grade.teacherComments.map((comment, idx) => (
                              <div
                                key={idx}
                                className={`rounded-lg border p-3 ${getCommentColor(comment.category)}`}
                              >
        ...
        <TabsContent value="progress" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Aylık performans değişimi</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <TabsContent value="calendar" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sınavlar, ödevler ve toplantılar</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <TabsContent value="notifications" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Okul ve öğretmenlerden gelen bildirimler</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {data.notifications.map((notification) => (
                  <div
                    key={notification.id}
                    className={`rounded-lg border p-4 ${!notification.read ? 'bg-blue-50' : ''}`}
                  >
        ...
        <TabsContent value="communication" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Öğretmenler ile doğrudan iletişim kurun</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
