    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 text-sm text-green-600">
              <TrendingUp className="h-3 w-3" />+{overallStats.improvementRate}% bu ay
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-sm text-gray-600">Toplam {overallStats.totalAssignments} ödev</div>
        ...
        <TabsContent value="subjects" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Her dersin ödev performansı ve trendleri</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <CardDescription>
                            {classData.studentCount} öğrenci • {classData.assignmentsCompleted}{' '}
                            tamamlanan ödev
                          </CardDescription>
                        </div>
                        <div className="text-right">
        ...
        <TabsContent value="time" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Farklı zaman periyotlarında ödev performansı</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <TabsContent value="difficulty" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Farklı zorluk seviyelerindeki ödev performansları</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Veriler doğrultusunda öneriler</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 rounded-lg bg-blue-50 p-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Zamanında teslim oranı %92&apos;ye çıktı. Öğrenciler süreleri daha iyi
                    yönetiyor.
                  </p>
                </div>
              </div>
